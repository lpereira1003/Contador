...
public class ProveedoresToCompras1 extends javax.swing.JInternalFrame {
    public ProveedoresToCompras1() {
        initComponents();
    ...
    private static final Logger LOG = Logger.getLogger(ProveedoresToCompras1.class.getName());
}
